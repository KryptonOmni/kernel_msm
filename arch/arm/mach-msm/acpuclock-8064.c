...
static struct l2_level l2_freq_tbl[] __initdata = {
		...
		[1]  = { {  192000, PLL_8, 0, 0x00 },  950000, 950000, 1 },
        [2]  = { {  384000, HFPLL, 2, 0x20 },  950000, 950000, 2 },
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(5),   950000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {    81000, HFPLL, 2, 0x06 }, L2(0),   800000 },
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(5),   900000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {    81000, HFPLL, 2, 0x06 }, L2(0),   800000 },
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(5),   850000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(5),   850000 },
